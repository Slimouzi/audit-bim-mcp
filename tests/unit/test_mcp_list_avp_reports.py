...
def test_plancher_est_de_nouveau_annonce_produisible(_isolated):
    """Le blocage était un motif MÉTIER, pas un manque de données : le lever
    n'a demandé aucune donnée supplémentaire, seulement une règle."""
    _isolated.snapshot = _snap_with_slab()
    out = tools_reporting.list_avp_i3f_xls_reports()
