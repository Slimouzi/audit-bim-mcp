...
sans conséquence. **`reporting` n'en est pas une.** 23 modules, **9 220 lignes**,
...
**`avp_snapshot.py` — 1 717 lignes, aucune dépendance I3F, aucun terme client.**
