...
sans conséquence. **`reporting` n'en est pas une.** 23 modules, **8 567 lignes**,
...
**`avp_snapshot.py` — 1 304 lignes, aucune dépendance I3F, aucun terme client.**
