...
sans conséquence. **`reporting` n'en est pas une.** 23 modules, **8 727 lignes**,
...
| Lié au livrable I3F par ses appelants | 9 | 2 603 |
...
**`avp_snapshot.py` — 1 432 lignes, aucune dépendance I3F, aucun terme client.**
