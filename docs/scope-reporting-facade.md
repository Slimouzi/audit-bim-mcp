...
sans conséquence. **`reporting` n'en est pas une.** 23 modules, **8 897 lignes**,
...
**`avp_snapshot.py` — 1 592 lignes, aucune dépendance I3F, aucun terme client.**
